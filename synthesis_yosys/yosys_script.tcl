...
read_verilog /home/gmsarath/Sarath/vlsi_wrk/sta_exercise/sta-project/rtl-design/*.v 

#elaborate design heirarchy
hierarchy -check -top alu_with_mux
...
write_verilog -noattr alu_sunthesized.v
